...
const kpi = [
  ...
  { icon: Timer, label: "Avg active", to: 6.4, suffix: "h", decimals: 1, tone: "#686EDA" },
  { icon: MonitorSmartphone, label: "Devices", to: 212, suffix: "", tone: "#8A8FE8" },
  { icon: Activity, label: "Idle rate", to: 3.1, suffix: "%", decimals: 1, tone: "#15F3AF" },
];
...
const label = "text-[0.6rem] font-medium uppercase tracking-[0.14em] text-faint";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* chrome */}
          <div className="flex items-center gap-2 border-b border-hair px-4 py-3" style={{ transform: "translateZ(30px)" }}>
            <span className="h-2.5 w-2.5 rounded-full bg-white/15" />
            <span className="h-2.5 w-2.5 rounded-full bg-white/15" />
            <span className="h-2.5 w-2.5 rounded-full bg-white/15" />
            <span className="ml-3 text-[0.66rem] text-faint">app.employeetracker.io / overview</span>
          ...
          <div className="grid gap-4 p-4 sm:p-5 lg:grid-cols-[1.5fr_1fr]">
            ...
            <div className="space-y-4" style={{ transform: "translateZ(45px)" }}>
                ...
                {kpi.map((k, i) => (
                  ...
                  >
                    ...
                    <div className="text-2xl font-semibold">
                      <CountUp to={k.to} suffix={k.suffix} decimals={k.decimals ?? 0} />
                    </div>
                  </motion.div>
                ))}
              </div>
            ...
            <div className="rounded-xl border border-hair bg-white/[0.02] p-3" style={{ transform: "translateZ(35px)" }}>
        ...
        <motion.div
          className="absolute -left-6 top-16 hidden rounded-xl border border-hairbright bg-surface-2/90 px-4 py-3 shadow-[0_20px_50px_-15px_rgba(104,110,218,0.6)] backdrop-blur sm:block"
        ...
        >
          ...
          <div className="mt-1 flex items-center gap-2">
            ...
            <span className="tnum text-xs text-indigo-soft">+6</span>
          </div>
        </motion.div>
